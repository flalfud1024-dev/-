...
### 2.4 미결: Yes24 한국 독자 서평 포함 여부
자문 자료에 Yes24(한국) 리뷰 수집 코드 포함되어 있고, 참고 논문(백선 2025)이 **한·중 독자 서평 비교** 연구임. 본 학위논문 스코프 결정 필요:

- **Option A**: 중국 독자만 (현 구성) → PRD v1.0대로 진행
- **Option B**: 한·중 비교로 확장 → PRD v1.1로 Yes24 모듈 추가
